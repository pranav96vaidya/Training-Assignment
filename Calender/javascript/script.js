...
var decrementMonth = document.getElementById('leftArrowMonth');
var incrementMonth = document.getElementById('rightArrowMonth');
var decrementYear = document.getElementById('leftArrowYear');
var incrementYear = document.getElementById('rightArrowYear');
...
for (var i = 0; i < weeks.length; i++) {
    ...
    outerdiv.className = "week-content";
    var newelement = document.createElement('div');
    outerdiv.appendChild(newelement);
    newelement.className = "date-content";
    document.getElementById('week-data').appendChild(outerdiv);
...
function getDays(year, month) {
    ...
    for (var i = 1 ; i <= lastDate; i++) {
        var incr;
        incr = lastDatePrev.getDate() - lastDatePrev.getDay();
        while (k < startingmonthday) { 
            ...
            incr++;
            document.getElementById('date').appendChild(outerdiv);
            k++;
        }
        var outerdiv = document.createElement('div');
        outerdiv.className = "week-content";
        ...
        for (var j = 0; j < bdays[months[month]].length; j++) {
            if (bdays[months[month]][j].dob.getDate() == i) {   
                ...
                x.onclick = function () {
                    document.querySelectorAll('.modal-title')[0].innerHTML = "Happy Birthday " + this.getAttribute('dataname');
                }
            }
        }
        nameAppend = [];
